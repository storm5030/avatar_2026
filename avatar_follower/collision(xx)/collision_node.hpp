...
//   // [수정 1] 끝단 링크도 왼쪽/오른쪽 구분
//   std::string tip_link_; // (필요 없다면 삭제 가능)
...
//   // [수정 2] 체인과 솔버를 왼쪽/오른쪽 각각 선언
//   KDL::Chain left_kdl_chain_;
//   KDL::Chain right_kdl_chain_;
